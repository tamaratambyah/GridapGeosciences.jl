...
writevtk(Ω_panel,dir*"/ambient_model",cellfields=["u"=>f_panel_cf],nsubcells=2,append=false,geo_map=_cell_geo_map)

output = visualization_data(Ω_panel,dir*"/ambient_model",nsubcells=2)
cdata = output[1].celldata

idxs = cdata["cell"]
_cell_geo_map =  cell_geo_map[vcat(panel_ids,panel_ids)]
