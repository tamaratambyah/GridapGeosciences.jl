"""
This is super hacky --- I copied the TransientThermalShallowWater.jl but need
to change initial conditions to run Galewsky test case
--- TO DO: tidy this up!!
"""
...
function post_process(panel_model,p_fe::Int,dir::String,f::Function,return_vtk=false)
  ...
  function make_vtk(t::Float64,xh,yh,cell_geo_map)
    ...
    writevtk(_Ω_panel,vtk_dir*"/solT_$t" * ".vtu", cellfields=cellfields,append=false,geo_map=latlon_geo_map_func(_Ω_panel))
  end
...
function main_transient(distribute,nprocs;
  restart=false,n_ref_lvls=5,p_fe=1,CFL=0.1,return_vtk=true)
